(function () {
    ...
    localStorage.setItem("basicBotsettings", JSON.stringify({
      ...
      skipPosition: 1,
      skipReasons: [
      ["theme", "Essa musiquinha não está de acordo com os termos da sala, vamos ler as regras? "],
      ["op", "Essa músiquinha tá na lista OP, só lamento! "],
      ["history", "Já tocaram essa musica, sua cega. "],
      ["mix", "You played a mix, which is against the rules. "],
      ["sound", "The song you played had bad sound quality or no sound. "],
      ["nsfw", "Eta! Essa musica possui conteúdo NSFW, só depois das 00h, ok? "],
      ["unavailable", "Viche mana, a musica tá indisponivel. Toca outra pra mim! "]
      ],
      afkpositionCheck: 15,
